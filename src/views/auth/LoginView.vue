<template>
  <div class="login-container min-h-screen flex flex-column align-items-center justify-content-center">
    <div class="login-card p-6 w-full lg:w-4">
      <div class="text-center mb-5">
        <div class="logo-container mb-4">
          <img src="/images/logo-udl.png" alt="UDL" class="logo-image" />
        </div>        <div class="page-title text-3xl font-bold mb-2">Unión Deportiva Laspiur</div>
        <span class="text-gray-400 font-medium">Bienvenido al sistema</span>
      </div>

      <form @submit.prevent="handleLogin">        <div class="mb-4">          <label for="identificador" class="block text-gray-300 font-medium mb-2">Usuario</label>
          <InputText
            id="identificador"
        ...
        <div class="mb-4">
          ...
          <!-- Link "Olvidé mi contraseña" solo para socios (email) -->
          <div v-if="esEmail" class="mt-2 text-right">
            <a href="#" @click.prevent="mostrarRecuperacion = true" class="text-sm text-primary-400 hover:text-primary-300">
      ...
      <div class="divider my-4 flex align-items-center gap-2">
        ...
        <span class="text-gray-500 text-sm">¿Sos nuevo?</span>
        <div class="divider-line flex-1"></div>
      </div>
